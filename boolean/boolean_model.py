from boolean.parser_boolean import ParserBoolean
import json
...
DIR = 'C:/Users/user/Documents/Estudio/3ero/2doSemestre/SRI/SRI bibliografía/Nueva carpeta'
...
class BooleanModel():
    def __init__(self, name_dataset) -> None:        
        ...
        datos = open_ocurrence(DIR + '/' + name_dataset + '/ocurrence.json')
    ...
    def ModDataset(self, name_dataset):
        ...
        terms = open_ocurrence(DIR + '/' + name_dataset + '/ocurrence.json')
